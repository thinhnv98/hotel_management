...
import 'package:hotel_management/src/screens/checkout_screen/checkout_screen.dart';
import 'package:hotel_management/src/screens/home_screen/services_page/services_page.dart';
import 'package:hotel_management/src/screens/room_detail_screen/widgets/room_services.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';

class RoomDetailScreenBuilder extends StatelessWidget {
  static const String id = "ROOM_DETAIL";
  final Room room;

  const RoomDetailScreenBuilder({Key key, this.room}) : super(key: key);
...
class RoomDetailBottom extends StatelessWidget {
  ...
  Widget buildRented(
      {@required Function serviceCallback,
      @required Function checkoutCallback}) {
    return Row(
        ...
        : buildRented(
            ...
            checkoutCallback: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      CheckoutScreen(roomSession: roomSession, room: room),
                ),
              );
            },
          );
